...
import { TokenMessageToPrepare, TransferMessageToPrepare, WalletMessageToSend } from '@shared/backgroundApi'
...
export interface TransactionContext {
	...
	selectableKeys: nt.KeyStoreEntry[];
...
const Context = React.createContext<TransactionContext>({
	...
	estimateFees() { return Promise.reject() },
	prepareMessage() { return Promise.reject() },
	prepareTokenMessage() { return Promise.reject() },
	sendMessage() { return Promise.reject() },
})
...
export function TransactionProvider({
	...
	const prepareMessage: TransactionContext['prepareMessage'] = (
		params,
		password
	) => {
